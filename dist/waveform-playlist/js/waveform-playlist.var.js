...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Playlist = __webpack_require__(32);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _patch = __webpack_require__(50);
	
	var _patch2 = _interopRequireDefault(_patch);
	
	var _inlineWorker = __webpack_require__(55);
	
	var _inlineWorker2 = _interopRequireDefault(_inlineWorker);
	
	var _conversions = __webpack_require__(56);
	
	var _LoaderFactory = __webpack_require__(57);
	
	var _LoaderFactory2 = _interopRequireDefault(_LoaderFactory);
	
	var _ScrollHook = __webpack_require__(61);
	
	var _ScrollHook2 = _interopRequireDefault(_ScrollHook);
	
	var _TimeScale = __webpack_require__(62);
	...
	var _Playout = __webpack_require__(80);
	
	var _Playout2 = _interopRequireDefault(_Playout);
	
	var _AnnotationList = __webpack_require__(81);
	...
	var _class = function () {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function initRecorder(stream) {
	      ...
	      var useMediaRecorder = 'MediaRecorder' in window;
	      ...
	      if (useMediaRecorder) {
	        ...
	        this.mediaRecorder.ondataavailable = function (e) {
	          ...
	          if (!_this.working) {
	            _this.working = true;
	            var numberOfChannels = _this.chunks[0].length;
	
	            var length = 0;
	            for (var i = 0; i < _this.chunks.length; i++) {
	              length += _this.chunks[i][0].length;
	            }
	
	            var audioBuffer = _this.ac.createBuffer(numberOfChannels, length * numberOfChannels, e.sampleRate);
	
	            for (var i = 0; i < numberOfChannels; i++) {
	              var channel = audioBuffer.getChannelData(i);
	              var index = 0;
	              for (var j = 0; j < _this.chunks.length; j++) {
	                channel.set(_this.chunks[j][i], index);
	                index += _this.chunks[j][i].length;
	              }
	            }
	            _this.recorderWorker.postMessage({
	              samples: audioBuffer.getChannelData(0),
	    ...
	    value: function setUpEventEmitter() {
	      ...
	      ee.on('delete', function () {
	        ...
	        _this2.setTimeSelection(timeSelection.start, timeSelection.start);
	        _this2.drawRequest();
	      });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _BlobLoader = __webpack_require__(58);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Loader2 = __webpack_require__(59);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _TimeScaleHook = __webpack_require__(63);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _lodash3 = __webpack_require__(65);
	...
	var _webaudioPeaks = __webpack_require__(68);
	
	var _webaudioPeaks2 = _interopRequireDefault(_webaudioPeaks);
	
	var _fadeMaker = __webpack_require__(69);
	...
	var _CanvasHook = __webpack_require__(77);
	
	var _CanvasHook2 = _interopRequireDefault(_CanvasHook);
	
	var _FadeCanvasHook = __webpack_require__(78);
	
	var _FadeCanvasHook2 = _interopRequireDefault(_FadeCanvasHook);
	
	var _VolumeSliderHook = __webpack_require__(79);
	    ...
	    */
	    ...
	    value: function _delete(start, end) {
	      ...
	      if (end < trackStart) {
	        ...
	        deleteStart = (0, _conversions.secondsToSamples)(deleteStart, sampleRate);
	        deleteEnd = (0, _conversions.secondsToSamples)(deleteEnd, sampleRate);
	        var newLength = length - (deleteEnd - deleteStart);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _rng = __webpack_require__(67);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _fadeCurves = __webpack_require__(70);
